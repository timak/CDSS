	...
	<table class="FULL_BLANK">
		<tr>
			<td valign="top">
				...
				</ul> <font color="orange">Warning: Please note that configuration
					changes done through the administration console will be lost when
					the server is restarted.</font>
			</td>
